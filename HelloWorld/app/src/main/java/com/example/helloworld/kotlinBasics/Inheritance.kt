...
// class implicitly inherits from the default Parent class - Any
...
open class Car(val name: String, val brand: String) {
    // open so it can be overridden by inheriting classes
...
fun main(args: Array<String>){
    ...
    // Or alternatively works if Car was a Interface and ElectricCar would inherit from it
    teslaS.drive(200.0)
}
